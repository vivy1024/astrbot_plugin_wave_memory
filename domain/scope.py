...
COMMAND_SCOPE_MATRIX: Mapping[str, ScopeRequirement] = MappingProxyType({
    ...
    "person.search": ScopeRequirement(("runtime",), ("group", "private")),
    "injection.trace.read": ScopeRequirement(("runtime",), ("group", "private")),
    "chat.browse": ScopeRequirement(("runtime",), ("group", "private")),
